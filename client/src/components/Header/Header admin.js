      ...
      <header>
        <Navbar bg="dark" variant="dark">
          ...
          <Nav className="mr-auto">
            <Nav.Link href="/UserApproval">사용자 관리</Nav.Link>
            <Nav.Link href="/AdminResearchProject">
              Research Projects 관리
            </Nav.Link>
            <Nav.Link href="SoftwareList">Software Tools 관리</Nav.Link>
            <Nav.Link href="AdminDataSourceList">Data Sources 관리</Nav.Link>
            <Nav.Link href="floatPopulationList">유동 인구 조회</Nav.Link>
            <Nav.Link href="SubCodeManage">Sub code 관리</Nav.Link>
          </Nav>
          <div className="hd_right">
            <p>
              <span>' {this.state.usernm} '</span>님 반갑습니다.
